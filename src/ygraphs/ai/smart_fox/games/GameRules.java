<<<<<<< HEAD:ygraphs/ai/smart_fox/games/GameRules.java
...
public class GameRules {
    ...
    protected ArrayList<Queen> getLegalMoves(Queen queen) {
        ...
        for(int i = 1; currentRow - i >= 0; i++) {
        	System.out.print("Row:"+currentRow+" Col: "+currentCol+" I: "+i+"\n");
            if(board[currentRow-i][currentCol] == null) {
                legalMoves.add(new Queen(currentRow-i, currentCol));
            }
            else {
...
>>>>>>> b48063156c9d35dddce045056cd6a78ee05abcc9:src/ygraphs/ai/smart_fox/games/GameRules.java
